...
class Annotator:
    ...
    def __init__(self, im, line_width=None, font_size=None, font='Arial.ttf', pil=True):
        ...
        if self.pil:  # use PIL
            ...
            try:
                ...
                self.font = ImageFont.truetype(font, size=f)
            _, fh = self._text_size('a')
            self.fh = fh - 3  # font height
        else:  # use cv2
            self.im = im
    ...
    def box_label(self, box, label='', color=(128, 128, 128), txt_color=(255, 255, 255)):
        ...
        if self.pil or not is_ascii(label):
            ...
            if label:
                w, _ = self._text_size(label)  # text width
    ...
    def _text_size(self, text):
        # Pillow 10 removed getsize; getbbox is the supported replacement.
    ...
    def text(self, xy, text, txt_color=(255, 255, 255)):
        ...
        _, h = self._text_size(text)  # text width, height
