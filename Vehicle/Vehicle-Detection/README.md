...
# Optional: set custom dataset root directory (overrides `path` inside dataset.yaml)
python train.py --img 640 --batch 16 --epochs 50 --data dataset.yaml --weights yolov5m.pt --input_data /path/to/your/Dataset
```
